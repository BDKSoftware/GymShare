...
function ChangeExerciseModal({
  ...
  const [exerciseGroup, setExerciseGroup] = useState(selectedExercise.group);
          ...
          renderItem={({ item }) => {
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  //Find selected exercise in exercises array and replace the exercise name with the new one and setState
